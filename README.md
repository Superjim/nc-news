...
| GET /api/articles                       | Retrieves an array of all articles in the API. <br />Default queries include 'sort_by' (created_at), 'order' (desc) and 'topic' (all). <br />Additional query parameters include 'sort_by' (article_id, title, topic, author, body, created_at, votes), 'order' (asc, desc), and 'topic' (slug of topic).                                                                                  |
