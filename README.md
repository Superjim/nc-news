...
If you would like to deploy the project yourself locally, you can do so by following the instructions in the "To setup and run this project locally" section of this README, or [_skip ahead to the routes_](##-6.-Routes)
